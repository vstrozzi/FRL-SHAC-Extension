...
import envs
import algorithms.shac_alpha as shac_alpha
import os
import sys
import yaml
import torch
...
def get_args(): # TODO: delve into the arguments
    custom_parameters = [
        ...
        {"name": "--cfg", "type": str, "default": "./cfg/shac_alpha/ant.yaml",
        ...
        {"name": "--logdir", "type": str, "default": "logs/tmp/shac_alpha/"},
...
if __name__ == '__main__':
    ...
    traj_optimizer = shac_alpha.SHAC_ALPHA(cfg_train)
