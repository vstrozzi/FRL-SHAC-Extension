...
import envs
import algorithms.shac_alpha_emp as shac_alpha_emp
import os
import sys
import yaml
import torch
...
def get_args(): # TODO: delve into the arguments
    custom_parameters = [
        ...
        {"name": "--cfg", "type": str, "default": "./cfg/shac_alpha_emp/ant.yaml",
        ...
        {"name": "--logdir", "type": str, "default": "logs/tmp/shac_alpha_emp/"},
...
if __name__ == '__main__':
    ...
    traj_optimizer = shac_alpha_emp.SHAC_ALPHA_EMP(cfg_train)
